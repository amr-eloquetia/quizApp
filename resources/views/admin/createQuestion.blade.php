...
<div class="container">
    <div class="row">
        <div class="col-lg-12 col-sm-12">
            <form action="{{ route('createQuestion.post') }}" method="POST" enctype="multipart/form-data">
                @csrf
                {{-- {{ method_field('put') }} --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group d-flex flex-column mr-4">
                                    ...
                                    <input type="text" id="product_price" name="question" class="p-3" placeholder="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group d-flex flex-column">
                                    ...
                                    <input type="text" name="answer1" class="p-3" placeholder="">
                                </div>
                            </div><!-- ends: .col-md-6 -->
                            <div class="col-md-6">
                                <div class="form-group d-flex flex-column">
                                    <label for="price">Answer 2</label>
                                    <input type="text" name="answer2" class="p-3" placeholder="">
                                </div>
                            </div><!-- ends: .col-md-6 -->
                        </div><!-- ends: .row -->
                    </div><!-- ends: .col-md-12 -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group d-flex flex-column">
                                    ...
                                    <input type="text" name="answer3" class="p-3" placeholder="">
                                </div>
                            </div><!-- ends: .col-md-6 -->
                            <div class="col-md-6">
                                <div class="form-group d-flex flex-column">
                                    <label for="price">Answer 4</label>
                                    <input type="text" name="answer4" class="p-3" placeholder="">
                                </div>
                            </div><!-- ends: .col-md-6 -->
                        </div><!-- ends: .row -->
                    </div><!-- ends: .col-md-12 -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group d-flex flex-column">
                                    ...
                                    <input type="text" name="rightAnswer" class="p-3" placeholder="">
                                </div>
                            </div><!-- ends: .col-md-6 -->
                        </div><!-- ends: .row -->
                    </div><!-- ends: .col-md-12 -->
